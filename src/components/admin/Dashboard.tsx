...
const stats = [
  { label: 'Clientes Activos', value: '4', icon: Users, color: '#F5611A', bg: 'rgba(245,97,26,0.15)' },
  { label: 'Sesiones Esta Semana', value: '12', icon: Calendar, color: '#10B981', bg: 'rgba(16,185,129,0.15)' },
  { label: 'Mensajes Sin Leer', value: '3', icon: MessageSquare, color: '#3B82F6', bg: 'rgba(59,130,246,0.15)' },
  { label: 'Cumplimiento Promedio', value: '83%', icon: TrendingUp, color: '#8B5CF6', bg: 'rgba(139,92,246,0.15)' },
]
